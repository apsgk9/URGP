...
namespace Movement
{
	...
	public class Mover : MonoBehaviour, IMover{
		...
		protected float sensorRadiusModifier = 0.8f;
		...
		protected bool IsUsingExtendedSensorRange  = true;
		protected float baseSensorRange = 0f;

		//Current upwards (or downwards) velocity necessary to keep the correct distance to the ground;
		protected Vector3 currentGroundAdjustmentVelocity = Vector3.zero;
		...
		void Check()
        {
            ...
            currentGroundAdjustmentVelocity = tr.up * (_distanceToGo / GetFixedDeltaTime());
        }
        ...
        public Vector3 GetCurrentGroundAdjustmentVelocity()
        {
            return currentGroundAdjustmentVelocity;
        }
