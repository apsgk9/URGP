...
public class PlayerSprintState : PlayerLocomotionBaseState
{
  public PlayerSprintState(Character currentContext, PlayerLocomotionStateFactory playerStateFactory)
  ...
  public override void UpdateState(){
    ...
    else
    {
      ...
      Ctx.Velocity= multipler*Ctx.SprintSpeed*Ctx.DesiredCharacterVectorForward;
    }
