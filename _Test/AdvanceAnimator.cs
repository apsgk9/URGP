...
public class AdvanceAnimator : MonoBehaviour
{
    ...
    private void RunAdvanceAnimator()
    {
        ...
        //To ensure animations play at the rate the time should be. TODO-- add option for animation to be unsacled time
        mixerMainPlayable.SetSpeed(Time.timeScale);
    ...
    private void LogWeights()
    {
        ...
        log = "TransitionStart: ";
        foreach (var weight in MixerWeightListatStartofTransition)
        {
            log += weight + " ";
        }
        Debug.Log(log);
    ...
    {
        //FadeClipInternal(_clipToFade, 0, true);
    ...
    {   
        //This caused me a lot of headaches... the transitions weights switched from 1,0 to 0,1 because it was return 1
        // so now it return 0 instead. It's only called in the beginning.
